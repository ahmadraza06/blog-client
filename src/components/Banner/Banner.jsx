...
export const Banner = () => {
  return (
    <div>
        <div className=" p-3 relative bg-gradient-to-r from-purple-600 to-blue-600 h-[50%] text-white overflow-hidden">
  ...
  <div className="relative z-10 flex flex-col justify-center items-center h-full text-center">
    <h1 className="text-9xl font-bold leading-tight mb-4">BLOG</h1>
